...
PS1="${COLOR1}[|${COLOR_RESET}\A${COLOR1}|]${COLOR_RESET}${COLOR1}-->${COLOR_RESET} ${COLOR2}\u${COLOR_RESET}${COLOR1}@${COLOR_RESET}${COLOR3}\h${COLOR_RESET} ${COLOR1}[${COLOR_RESET}${COLOR4}\W${COLOR_RESET}${COLOR1}]${COLOR_RESET} ${COLOR2}\\\$${COLOR_RESET} ${COLOR1}:${COLOR_RESET}  ";
